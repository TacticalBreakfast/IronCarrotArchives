...
tags = ['Mastery', 'Medics', 'Arknights', 'Guide', 'Skill Priority']
+++
...
Additionally, it's worth a quick note that Titi's S3 still does have some Advanced value. In particular, it cycles well with Tragodia's S3 so is sometimes used in advanced stall compositions to cover his downtime. However, this is an extremely advanced usage even beyond what this guide typically considers, so isn't given a lot of weight here in the grades.
...
{{< mastery-table-enhanced id="187_ccheal" rows="S1M3,None,None" >}}
