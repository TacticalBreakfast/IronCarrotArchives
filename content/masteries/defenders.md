...
- [5★ Defenders](#5-defenders)
- [4★ Defenders](#4-defenders)
- [4★ and 5★ Ungraded Defenders](#4-and-5-ungraded-defenders)
## 6★ Defenders
...
Pass on her S1, which is a relatively boring straight HP increase. It's worse than Philae's similar S1, which is also ungraded and also rarely, if ever, used. However, it manages to be somewhat unique still, which *may* have some use for the true maximialists. At full investment and with her Module, she can reach 9161 HP which is among the highest in the game, even at the higher rarities, plus her NI Talent. However, in practical terms, there's almost always better solutions, including her own S2 which already indirectly improves her HP, so is still an extremely fringe consideration.
...
That's all a rather flowery way to say that yes, Gummy is a really good unit that might be worth Mastery consideration. She's cheap, common, and very useful. However, there's some nuance here. It still costs Hope to promote units in IS, [the optimal play is usually to just use most of them for starting and not spend the extra to promote](masteries/othertopics/#should-you-e2m3-4s-for-is). That's a discussion that's largely absent from many 4★ write-ups in this guide due to being out of scope, but is exceedingly relevant for Gummy!
...
{{< mastery-table-enhanced id="260_durnar" rows="S2M3,None,None" >}}
