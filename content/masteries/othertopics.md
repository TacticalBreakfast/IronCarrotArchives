...
- [Why isn't the Mastery guide integrated with the Tier List rankings? Why don't the grades match?](#why-isnt-the-mastery-guide-integrated-with-the-tier-list-rankings-why-dont-the-grades-match)
- [Why aren't Module ratings integrated into the Mastery guide?](#why-arent-module-ratings-integrated-into-the-mastery-guide)
- [What is meant when you say "specific solutions are never required"?](#what-is-meant-when-you-say-specific-solutions-are-never-required)
- [A discussion on Wandering Medics and priority.](#a-discussion-on-wandering-medics-and-priority)
- [Should you E2/M3 4★s for IS?](#should-you-e2m3-4s-for-is)
...
- [A General Overview of Shifter Skills](#a-general-overview-of-shifter-skills)
