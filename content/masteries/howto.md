...
You may know this guide from Gamepress, which is now defunct, so this, and the [Google Sheet version](https://docs.google.com/spreadsheets/d/1iJF12O6QOba1dlUVmobwvc1eBZE7FRB6-tKxmZEcG1I/), will now serve as the permanent home of the full guide. This sheet will continue to be the permanent home and be updated for as long as the guide is still maintained, even if I begin to post it on another site.

If you spot any mistakes please let me know! There's [a Reddit feedback thread here](https://www.reddit.com/user/TacticalBreakfast/comments/1pl4nne/a_mastery_priority_guide_feedback_comments_corner/) or any of my socials linked above.
...
If you're looking for general Module suggestions, I would recommend DragonGJY's Grade sheet which can be found [here](https://docs.google.com/spreadsheets/u/0/d/1A0_0XTAcDDtHkvyAwjTqEEzM8cf5h3E60u23ZVXw4eg/htmlview) or Mal's articles on the [LD page here](https://lungmendragons.com/guides).
...
Note previous iterations of this guide excluded IS from Story grades. This is no longer true and as noted above, low-difficulty IS is considered in this grade. You can find a full explanation [over here](http://localhost:1313/masteries/othertopics/#whats-going-on-with-the-is-grades-why-are-many-updated-write-ups-missing-them).
...
Note Roguelike grades used to be universal in the guide, but will be phased out as a general grade beginning in Oct 2025. You can find the full explanation [over here](http://localhost:1313/masteries/othertopics/#whats-going-on-with-the-is-grades-why-are-many-updated-write-ups-missing-them).
...
Big thanks to everyone who helps me proof the articles and writeups, especially my Tier List homies.
Special thanks to Danbo for giving the article a home and being a community mainstay, and Ivoryalas for helping me with the Sheets migration.
Icon by patuwu.station.
